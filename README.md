...
Pressing f11 toggles fullscreen. If you wish
...
## High scores
Clear button erases all registered scores PERMANENTLY.  ****Reads Wipe db(database) on hover
...
To play your own custom background music move the desired mp3 file into the Game_Audio\background_music folder   ***It selects and plays songs in a random order
For custom sound effects move the desired mp3 file into sound_effect_folder and delete the default mp3 file      ***Only one will play at a time.
Same thing for background images.

The game should work decently well under these conditions.
####Restarting the game sets all values to default.***Only scores are stored.
